Class\_10 Cancer cell analysis
================
Gorm Leo Carstensen
6/2/2020
...
First we import to (i.e.) read our input data. i downloaded the CSV file
...
There are some funkey things in this dataset that we will ignoe for our
analysis. This includes the first and second ID and Diagnosis column and
the funny last X column (col 33).
...
Before we turn to PCA we need to think, or consider, wether we should
scale our input.
...
captured by the principal components (PCs)?
...
![](Class_10-PCA-Cancer-cell-analysis_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->

What a hot mess\!\! Lets do our own PC1 vs PC2 plot and color by the
diagnosis
...
![](Class_10-PCA-Cancer-cell-analysis_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](Class_10-PCA-Cancer-cell-analysis_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](Class_10-PCA-Cancer-cell-analysis_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](Class_10-PCA-Cancer-cell-analysis_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
new\<-read.csv(“new\_samples.csv”) new

Use the predict function with our previous PCA model and new data

npc \<- predict(wisc.pr, newdata=new) npc
